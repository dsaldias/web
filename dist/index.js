...
import { Fragment, Transition, computed, createBlock, createCommentVNode, createElementBlock, createElementVNode, createTextVNode, createVNode, defineAsyncComponent, defineComponent, inject, nextTick, normalizeClass, normalizeStyle, onBeforeMount, onMounted, onUnmounted, openBlock, ref, renderList, resolveComponent, resolveDynamicComponent, toDisplayString, unref, watch, withCtx, withDirectives, withKeys, withModifiers } from "vue";
...
var datitos = async (datos) => {
	if (!datos) return;
	const { useLoginStore } = await import("./user-BCmxZP6c.js").then((n) => n.n);
...
var setChat = async (datos) => {
	if (!datos) return;
	const { useLoginStore } = await import("./user-BCmxZP6c.js").then((n) => n.n);
	const store = useLoginStore();
	const userId = (typeof store.dataUser == "string" ? JSON.parse(store.dataUser) : store.dataUser)?.usuario?.id;
...
var _hoisted_2$16 = { class: "col-xs-12 flex flex-center" };
var _hoisted_3$14 = { class: "col-xs-12 col-sm-6" };
var _hoisted_4$9 = { class: "col-xs-12 col-sm-6" };
var _hoisted_5$7 = { class: "col-xs-12 col-sm-6" };
var _hoisted_6$7 = { class: "col-xs-12 col-sm-6" };
var _hoisted_7$5 = { class: "col-xs-12 col-sm-6" };
var _hoisted_8$5 = { class: "col-xs-12 col-sm-6" };
var _hoisted_9$5 = { class: "col-xs-12" };
var _hoisted_10$4 = { class: "col-xs-12 row items-center q-gutter-x-sm" };
var _hoisted_11$4 = { class: "col-xs-12 col-sm-8" };
var _hoisted_12$3 = { class: "col-xs-12 col-sm-4 row items-center q-gutter-x-xs" };
var _hoisted_13$3 = {
	class: "text-caption",
	style: { "opacity": ".6" }
};
var _hoisted_14$3 = { class: "col-xs-12" };
					...
					default: withCtx(() => [createVNode(QForm, { onSubmit: $setup.onSubmit }, {
						default: withCtx(() => [
							createElementVNode("div", _hoisted_1$20, [
								createElementVNode("div", _hoisted_2$16, [createVNode(QAvatar, { size: "90px" }, {
								...
								createElementVNode("div", _hoisted_3$14, [createVNode(QInput, {
									outlined: "",
								...
								createElementVNode("div", _hoisted_4$9, [createVNode(QInput, {
									outlined: "",
								...
								createElementVNode("div", _hoisted_5$7, [createVNode(QInput, {
									outlined: "",
								...
								createElementVNode("div", _hoisted_6$7, [createVNode(QInput, {
									outlined: "",
								...
								createElementVNode("div", _hoisted_7$5, [createVNode(QInput, {
									outlined: "",
								...
								createElementVNode("div", _hoisted_8$5, [createVNode(QInput, {
									outlined: "",
								...
								createElementVNode("div", _hoisted_9$5, [createVNode(QInput, {
									outlined: "",
								...
								createElementVNode("div", _hoisted_11$4, [createVNode(QFile, {
									clearable: "",
								...
								createElementVNode("div", _hoisted_12$3, [createVNode(QBtn, {
									color: "primary",
									icon: "fmd_good",
									flat: "",
									"no-caps": "",
									...
									_: 1
								}), createElementVNode("span", _hoisted_13$3, toDisplayString($setup.input.latitud) + " " + toDisplayString($setup.input.longitud), 1)]),
								createElementVNode("div", _hoisted_14$3, [createVNode(QSeparator, { class: "q-mb-sm" }), createVNode(QInput, {
									outlined: "",
...
//#endregion
//#region src/stores/auth/services/chatsService.ts
var ChatsService = class {
	async usuarios_chat(input = {}) {
		return await query$1(`
    ...
    `, { user_id }).then((d) => d).catch((e) => e);
	}
	async chats_no_leidos(user_id) {
		return await query$1(`
	...
	async chat_mensajes(conversacion_id) {
		return await query$1(`
    ...
    `, { conversacion_id }).then((d) => d).catch((e) => e);
	}
	async chat_enviar_mensaje(input) {
		return await mutar$1(`
...
//#endregion
//#region src/components/auth/chat/chat_modal.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1$19 = {
	key: 0,
	class: "chat-picker"
};
var _hoisted_2$15 = {
	key: 0,
	class: "chat-state chat-state--small"
};
var _hoisted_3$13 = {
	key: 1,
	class: "chat-state chat-state--small"
...
var _hoisted_14$2 = { class: "row no-wrap q-gutter-xs" };
//#endregion
//#region src/components/auth/chat/chat_modal.vue
var chat_modal_default = /*#__PURE__*/ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	__name: "chat_modal",
	setup(__props, { expose: __expose }) {
		...
		const participantIds = computed(() => {
			...
			return Array.from(new Set(messages.value.map((message) => String(message.sender_id || "")).filter(Boolean)));
		});
		...
		watch(() => store.chat, (chat) => {
			handleIncomingChatNotification(chat);
		});
		async function open() {
			isOpen.value = true;
		...
		async function loadChats() {
			...
			errorMessage.value = "";
			try {
				const response = await chatsService.chats_by_user(currentUserId.value);
		...
		async function loadMessages() {
			...
			messagesError.value = "";
			try {
				const response = await chatsService.chat_mensajes(String(selectedChat.value.id));
		...
		async function searchUsers() {
			...
			try {
				if (!allUsers.value.length) {
					const response = await chatsService.usuarios_chat({ rol: null });
		...
		function filterUsers(users, text) {
			...
			return users.filter((user) => String(user.id || "") !== currentUserId.value).filter((user) => normalizeSearch(userName(user)).includes(search)).slice(0, 50);
		}
		...
		function startChatWithUser(user) {
			selectedChat.value = {
				...
				tipo: "chat",
				miembros: [{ usuario_id: currentUserId.value }, { usuario_id: user.id }]
			};
			userPickerOpen.value = false;
			messages.value = [];
			messagesError.value = "";
		...
		async function handleIncomingChatNotification(chat) {
		...
		function notificationConversationId(chat) {
		...
		async function sendMessage() {
			...
			try {
				const created = (await chatsService.chat_enviar_mensaje({
		...
		function chatMemberIds(chat) {
			const members = Array.isArray(chat?.miembros) ? chat.miembros : [];
			return Array.from(new Set(members.map((member) => String(member?.usuario_id || "")).filter(Boolean)));
		}
		function chatUnreadCount(chat) {
			const value = Number(chat?.no_leidos || 0);
			return Number.isFinite(value) ? value : 0;
		}
		function chatUnreadLabel(chat) {
		...
		function userName(user) {
			return [
				...
				user.apellido1,
				user.apellido2
			].filter(Boolean).join(" ") || `Usuario ${user.id || ""}`;
		}
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(QDialog, {
				...
				default: withCtx(() => [createVNode(QCard, { class: "chat-modal" }, {
					default: withCtx(() => [createVNode(QToolbar, { class: "chat-toolbar" }, {
						default: withCtx(() => [
							selectedChat.value ? (openBlock(), createBlock(QBtn, {
								key: 0,
								flat: "",
								round: "",
								dense: "",
							...
							createVNode(QToolbarTitle, { class: "ellipsis" }, {
								default: withCtx(() => [createTextVNode(toDisplayString(selectedChat.value ? chatName(selectedChat.value) : userPickerOpen.value ? "Nuevo chat" : "Chat"), 1)]),
								_: 1
							}),
							!selectedChat.value && !userPickerOpen.value ? (openBlock(), createBlock(QBtn, {
								key: 1,
								flat: "",
								round: "",
								dense: "",
						...
						_: 1
					}), createVNode(QCardSection, { class: "chat-body" }, {
						default: withCtx(() => [!selectedChat.value && userPickerOpen.value ? (openBlock(), createElementBlock("div", _hoisted_1$19, [
							createElementVNode("div", null, [createVNode(QBtn, {
								dense: "",
								outline: "",
								color: "primary",
								icon: "arrow_back",
							...
							createVNode(QInput, {
								modelValue: userSearch.value,
								"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => userSearch.value = $event),
								modelModifiers: { trim: true },
								dense: "",
								outlined: "",
								clearable: "",
								...
								prepend: withCtx(() => [createVNode(QIcon, { name: "search" })]),
								append: withCtx(() => [createVNode(QBtn, {
									dense: "",
									flat: "",
									color: "primary",
									label: "Buscar",
									disable: usersLoading.value || userSearch.value.length < 2,
									onClick: searchUsers
								}, null, 8, ["disable"])]),
								_: 1
							}, 8, ["modelValue"]),
							usersLoading.value ? (openBlock(), createElementBlock("div", _hoisted_2$15, [createVNode(QSpinner, {
								color: "primary",
								size: "28px"
							}), _cache[3] || (_cache[3] = createElementVNode("strong", null, "Buscando usuarios", -1))])) : usersError.value ? (openBlock(), createElementBlock("div", _hoisted_3$13, [
								createVNode(QIcon, {
									name: "chat",
									size: "30px",
									color: "primary"
								}),
								_cache[4] || (_cache[4] = createElementVNode("strong", null, "No se pudo buscar", -1)),
								createElementVNode("span", null, toDisplayString(usersError.value), 1)
							])) : !userResults.value.length ? (openBlock(), createElementBlock("div", _hoisted_4$8, [
								createVNode(QIcon, {
									name: "person_search",
									size: "30px",
									color: "primary"
								}),
								_cache[5] || (_cache[5] = createElementVNode("strong", null, "Busca por nombre", -1)),
								_cache[6] || (_cache[6] = createElementVNode("span", null, "Escribe al menos 2 caracteres.", -1))
							])) : (openBlock(), createBlock(QList, {
								key: 3,
								class: "chat-user-list",
								separator: ""
							}, {
								default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(userResults.value, (user) => {
									return openBlock(), createBlock(QItem, {
										key: String(user.id),
										clickable: "",
										dense: "",
										class: "chat-user-item",
										onClick: ($event) => startChatWithUser(user)
									}, {
										default: withCtx(() => [createVNode(QItemSection, { avatar: "" }, {
											default: withCtx(() => [createVNode(QAvatar, {
												...
												default: withCtx(() => [createTextVNode(toDisplayString(userInitial(user)), 1)]),
												_: 2
											}, 1024)]),
											_: 2
										}, 1024), createVNode(QItemSection, null, {
											default: withCtx(() => [createVNode(QItemLabel, { class: "ellipsis" }, {
												default: withCtx(() => [createTextVNode(toDisplayString(userName(user)), 1)]),
												_: 2
											}, 1024)]),
											_: 2
										}, 1024)]),
						...
						])) : !selectedChat.value && loading.value ? (openBlock(), createElementBlock("div", _hoisted_5$6, [createVNode(QSpinner, {
							color: "primary",
							size: "32px"
						}), _cache[7] || (_cache[7] = createElementVNode("strong", null, "Cargando chats", -1))])) : !selectedChat.value && errorMessage.value ? (openBlock(), createElementBlock("div", _hoisted_6$6, [
							createVNode(QIcon, {
								name: "chat",
								size: "34px",
								color: "primary"
							}),
							_cache[8] || (_cache[8] = createElementVNode("strong", null, "No se pudieron cargar los chats", -1)),
						...
						])) : !selectedChat.value && !chats.value.length ? (openBlock(), createElementBlock("div", _hoisted_7$4, [createVNode(QIcon, {
							name: "chat",
							size: "34px",
							color: "primary"
						}), _cache[9] || (_cache[9] = createElementVNode("strong", null, "Sin conversaciones", -1))])) : !selectedChat.value ? (openBlock(), createBlock(QList, {
							key: 4,
							class: "chat-list",
							separator: ""
						}, {
							default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(chats.value, (chat) => {
								return openBlock(), createBlock(QItem, {
									key: String(chat.id),
									clickable: "",
									dense: "",
									class: "chat-item",
									onClick: ($event) => openMessages(chat)
								}, {
									default: withCtx(() => [
										createVNode(QItemSection, { avatar: "" }, {
											default: withCtx(() => [createVNode(QAvatar, {
												...
												default: withCtx(() => [chat.foto_url ? (openBlock(), createBlock(QImg, {
													key: 0,
													src: String(chat.foto_url)
												}, null, 8, ["src"])) : (openBlock(), createElementBlock("span", _hoisted_8$4, toDisplayString(chatInitial(chat)), 1))]),
												_: 2
											}, 1024)]),
											_: 2
										}, 1024),
										createVNode(QItemSection, null, {
											default: withCtx(() => [createVNode(QItemLabel, { class: "chat-name" }, {
												default: withCtx(() => [createTextVNode(toDisplayString(chatName(chat)), 1)]),
												_: 2
											}, 1024), createVNode(QItemLabel, {
												caption: "",
												class: "ellipsis"
											}, {
												default: withCtx(() => [createTextVNode(toDisplayString(chatPreview(chat)), 1)]),
												_: 2
											}, 1024)]),
											_: 2
										}, 1024),
										createVNode(QItemSection, {
											...
											default: withCtx(() => [chatUnreadCount(chat) > 0 ? (openBlock(), createBlock(QBadge, {
												key: 0,
												color: "red",
												rounded: "",
												label: chatUnreadLabel(chat)
											}, null, 8, ["label"])) : createCommentVNode("", true), createElementVNode("small", null, toDisplayString(chatDate(chat)), 1)]),
											_: 2
										}, 1024)
									]),
									_: 2
							...
							createElementVNode("div", {
								ref_key: "messageScrollRef",
								ref: messageScrollRef,
								class: "chat-message-scroll"
							}, [messagesError.value ? (openBlock(), createElementBlock("div", _hoisted_10$3, [
								createVNode(QIcon, {
									name: "chat",
									size: "30px",
									color: "primary"
								}),
								_cache[10] || (_cache[10] = createElementVNode("strong", null, "No se pudieron cargar los mensajes", -1)),
								createElementVNode("span", null, toDisplayString(messagesError.value), 1),
								createVNode(QBtn, {
									dense: "",
									outline: "",
									color: "primary",
							...
							])) : !messages.value.length ? (openBlock(), createElementBlock("div", _hoisted_11$3, [createVNode(QIcon, {
								name: "chat",
								size: "30px",
								color: "primary"
							}), _cache[11] || (_cache[11] = createElementVNode("strong", null, "Sin mensajes", -1))])) : createCommentVNode("", true), messages.value.length ? (openBlock(), createElementBlock("div", _hoisted_12$2, [(openBlock(true), createElementBlock(Fragment, null, renderList(messages.value, (message) => {
								return openBlock(), createElementBlock("div", {
									key: String(message.id),
									class: normalizeClass(["chat-message", { "chat-message--mine": isMine(message) }])
								}, [createElementVNode("span", null, toDisplayString(messageText(message)), 1), createElementVNode("small", null, toDisplayString(messageTime(message)), 1)], 2);
							}), 128)), createElementVNode("span", {
								ref_key: "messageBottomRef",
								ref: messageBottomRef,
								class: "chat-message-bottom"
							}, null, 512)])) : createCommentVNode("", true)], 512),
							messagesLoading.value ? (openBlock(), createBlock(QLinearProgress, {
								key: 0,
								dark: "",
								rounded: "",
								indeterminate: "",
							...
							createVNode(QForm, {
								...
								default: withCtx(() => [composerBlockedReason.value ? (openBlock(), createElementBlock("div", _hoisted_13$2, toDisplayString(composerBlockedReason.value), 1)) : createCommentVNode("", true), createElementVNode("div", _hoisted_14$2, [createVNode(QInput, {
									modelValue: draftMessage.value,
									"onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => draftMessage.value = $event),
									dense: "",
									outlined: "",
									class: "col",
									placeholder: "Escribe un mensaje",
									disable: Boolean(composerBlockedReason.value) || sendingMessage.value
								}, null, 8, ["modelValue", "disable"]), createVNode(QBtn, {
									round: "",
									color: "primary",
									icon: "send",
									type: "submit",
									loading: sendingMessage.value,
									disable: Boolean(composerBlockedReason.value) || !draftMessage.value.trim()
...
var boton_perfil_vue_vue_type_script_lang_default = {
	...
	setup() {
		...
		const loadChatUnreadCount = async (userId) => {
			if (!userId) return;
			try {
				const res = await chatsService.chats_no_leidos(userId);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	const _component_ChatModal = resolveComponent("ChatModal");
	return openBlock(), createElementBlock("div", _hoisted_1$18, [
		createVNode(QBtn, {
			...
			default: withCtx(() => [
				...
				$setup.store.chatUnreadCount > 0 ? (openBlock(), createBlock(QBadge, {
					key: 0,
					color: "red",
					rounded: "",
					floating: "",
					label: $setup.chatUnreadLabel
				...
				createVNode(QMenu, null, {
					default: withCtx(() => [createElementVNode("div", _hoisted_4$7, [
						createElementVNode("div", _hoisted_5$5, [
							_cache[5] || (_cache[5] = createElementVNode("div", { class: "text-subtitle2 text-weight-medium q-mb-xs" }, "Mi Perfil", -1)),
							...
							withDirectives((openBlock(), createBlock(QBtn, {
								...
								size: "sm",
								stretch: "",
								onClick: _cache[2] || (_cache[2] = ($event) => $setup.openChat())
							}, {
								default: withCtx(() => [$setup.store.chatUnreadCount > 0 ? (openBlock(), createBlock(QBadge, {
									key: 0,
									color: "red",
									rounded: "",
									floating: "",
		...
		createVNode(_component_ChatModal, { ref: "refChatModal" }, null, 512)
	]);
}
...
var MainLayout_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const router = useRouter();
		const Login = defineAsyncComponent(() => import("./login-index-DhRCKAnw.js"));
		const usuarios_conectados = defineAsyncComponent(() => import("./usuarios_conectados-COSWJz8C.js"));
		const showConectados = ref(false);
		const pendingOpenConectados = ref(false);
		const edgeLightRef = ref(null);
